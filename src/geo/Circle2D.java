...
public class Circle2D implements GeoShapeable{
	...
	@Override
	public void scale(Point2D center, double ratio) 		//sends the points of the circle to the function scale in point2D
	{
		if (ratio>0)
		{
	...
	@Override
	public void rotate(Point2D center, double angleDegrees) //sends the points of the circle to the function rotate in point2D
	{
